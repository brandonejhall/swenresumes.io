%-------------------------
% SwenResumes - Template 5: Contemporary Visual
% Contemporary layout with subtle visual hierarchy
% Optimized for ATS with balanced design
% SINGLE PAGE LAYOUT
%-------------------------
...
\titleformat{\section}{
  \vspace{-6pt}\large\bfseries\color{steelblue}
}{}{0em}{}[\vspace{0.2cm}]
...
%-------------------------
% HEADER - Compact header with smaller banner
%-------------------------
\begin{tikzpicture}[remember picture, overlay]
\fill[steelblue] (current page.north west) rectangle ([yshift=-1.2in]current page.north east);
\end{tikzpicture}
