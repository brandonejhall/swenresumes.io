%-------------------------
% SwenResumes - Template 2: Traditional Professional
% A traditional format with clear section demarcation
% Optimized for ATS with standard section headers
% SINGLE PAGE LAYOUT
%-------------------------
...
}{}{0em}{}[\color{steelblue}\titlerule \vspace{0.2cm}]
...
\begin{tabular}{r}
    ...
    \small\faIcon{linkedin} \href{https://linkedin.com/in/{LINKEDIN}}{{LINKEDIN}} \\
    \small\faIcon{github} \href{https://github.com/{GITHUB}}{{GITHUB}} \\
\end{tabular}
\end{tabularx}
